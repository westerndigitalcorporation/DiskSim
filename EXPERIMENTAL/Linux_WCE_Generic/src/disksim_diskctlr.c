...
#ifdef DEBUG_DISKCTLR
    fprintf (outputfile, "********** %f: disk_send_event_up_path - devno %d, type %d, cause %d, blkno %d, bcount %d\n", simtime, curr->devno, curr->type, curr->cause, curr->blkno, curr->bcount );
    fflush( outputfile );
#endif
...
#ifdef DEBUG_DISKCTLR
    fprintf (outputfile, "********** %f: disk_bus_delay_complete - devno %d, type %d, cause %d, blkno %d, bcount %d\n", simtime, curr->devno, curr->type, curr->cause, curr->blkno, curr->bcount );
#endif
...
static void disk_reconnection_or_transfer_complete (ioreq_event *curr)
{
...
#ifdef DEBUG_DISKCTLR
    fprintf (outputfile, "********** %f: disk_reconnection_or_transfer_complete - currdiskreq %p, devno %d, type %d, cause %d, blkno %d, bcount %d\n", simtime, currdiskreq, curr->devno, curr->type, curr->cause, curr->blkno, curr->bcount );
    fflush(outputfile);
#endif
    ...
    fprintf (outputfile, "********** %f: disk_reconnection_or_transfer_complete - type %s (%d), cause %s (%d), devno %d, blkno %d, bcount %d, flags %X\n", simtime, getEventString( curr->type ), curr->type, iosim_decodeInterruptEvent( curr ), curr->cause, curr->devno, curr->blkno, curr->bcount, curr->flags );
    fflush(outputfile);
#endif
...
#ifdef DEBUG_DISKCTLR
    fprintf (outputfile, "********** %f: disk_check_hda  ioreqlist %p\n", simtime, nextdiskreq->ioreqlist);
    fflush(outputfile);
#endif
        ...
        int ok_to_check_bus)
{
    ...
    fprintf (outputfile, "********** %f: DISK_ACTIVATE_WRITE  type %s (%d), device %d, blkno %d, bcount %d, flags %d\n",
                         simtime,
                         getEventString(currdiskreq->ioreqlist->type), currdiskreq->ioreqlist->type,
                         currdiskreq->ioreqlist->devno,
                         currdiskreq->ioreqlist->blkno,
...
disk_request_arrive(ioreq_event *curr)
{
    ...
    fprintf(outputfile, "cause %d, devno %d, blkno %d, bcount %d, flags 0x%x\n", curr->cause, curr->devno, curr->blkno, curr->bcount, curr->flags );
    fflush(outputfile);
#endif
...
#ifdef DEBUG_DISKCTLR
    fprintf (outputfile, "%f: disk_event_arrive  Entering  type %s (%d), devno %d, blkno %d, bcount %d, flags %d\n", simtime, getEventString(curr->type), curr->type, curr->devno, curr->blkno, curr->bcount, curr->flags );
#endif
