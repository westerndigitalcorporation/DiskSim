...
static void controller_53c700_reset_complete (controller *currctlr, ioreq_event *curr)
{
   ioreq_event *tmp;
    ...
    fprintf (outputfile, "*** %f: controller_53c700_reset_complete - devno %d, blkno %lld\n, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
    fflush( outputfile );
#endif
...
#ifdef DEBUG_CTLRDUMB
    fprintf (outputfile, "*** %f: controller_53c700_reconnection_complete - devno %d, blkno %lld\n, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
    fflush( outputfile );
#endif
...
{
#ifdef DEBUG_CTLRDUMB
    fprintf (outputfile, "*** %f: controller_53c700_reconnect_to_transfer - devno %d, blkno %lld\n, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
    fflush( outputfile );
#endif
...
#ifdef DEBUG_CTLRDUMB
    fprintf (outputfile, "*** %f: controller_53c700_request_complete - devno %d, blkno %lld\n, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
	fflush( outputfile );
#endif
...
#ifdef DEBUG_CTLRDUMB
    fprintf (outputfile, "%f: controller_53c700_disconnect - devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
#endif
...
{
#ifdef DEBUG_CTLRDUMB
    fprintf (outputfile, "%f: controller_53c700_ready_to_transfer - devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
    fflush( outputfile );
#endif
...
{
#ifdef DEBUG_CTLRDUMB
    fprintf (outputfile, "%f: controller_53c700_request_arrive - devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
    fflush(outputfile );
#endif
...
{
#ifdef DEBUG_CTLRDUMB
    fprintf (outputfile, "%f: controller_53c700_interrupt_arrive - devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
    fflush(outputfile );
#endif
...
{
#ifdef DEBUG_CTLRDUMB
    fprintf (outputfile, "%f: controller_53c700_interrupt_complete - devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
    fflush(outputfile );
#endif
...
#ifdef DEBUG_CTLRDUMB
    fprintf (outputfile, "%f: controller_53c700_data_transfer - devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
    fflush(outputfile );
/*
...
#ifdef DEBUG_CTLRDUMB
    fprintf (outputfile, "%f: controller_53c700_data_transfer_complete - devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
    fflush(outputfile );
#endif
...
#ifdef DEBUG_CTLRDUMB
    fprintf (outputfile, "%f: controller_53c700_event_arrive - devno %d, blkno %lld\n, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
    fflush(outputfile );
#endif
...
#ifdef DEBUG_CTLRDUMB
    fprintf (outputfile, "%f: controller_passthru_event_arrive - devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
    fflush(outputfile );
#endif
