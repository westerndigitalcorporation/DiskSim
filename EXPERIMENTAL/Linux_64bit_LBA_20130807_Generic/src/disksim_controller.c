...
dump_ioreq_event(ioreq_event *event, char *msg )
{
    ...
    while( NULL != myEvent )
    {
        ...
        fprintf (outputfile, "\n*** %f:    blkno       : %lld", simtime, myEvent->blkno );
...
#ifdef DEBUG_CONTROLLER
     fprintf (outputfile, "*** %f: controller_get_upward_busno  ctlno %d, busno %d, slotno %d, type %d, blkno %lld, bcount %d, flags 0x%x, addr %p\n", simtime, currctlr->ctlno, curr->busno, curr->slotno, curr->type, curr->blkno, curr->bcount, curr->flags, curr);
     fflush( outputfile );
#endif
...
#ifdef DEBUG_CONTROLLER
     fprintf (outputfile, "*** %f: controller_send_event_down_path - ctlno %d, , type %d, cause %s, blkno %lld, bcount %d, flags 0x%x, addr %p\n", simtime, currctlr->ctlno, curr->type, getCauseString( curr->cause ), curr->blkno, curr->bcount, curr->flags, curr);
     fflush( outputfile );
#endif
...
#ifdef DEBUG_CONTROLLER
     fprintf (outputfile, "*** %f: controller_send_event_down_path - ctlno %d, busno %d, slotno %d, type %d, blkno %lld, bcount %d, flags 0x%x, addr %p\n", simtime, currctlr->ctlno, busno, slotno, curr->type, curr->blkno, curr->bcount, curr->flags, curr);
     fflush( outputfile );
#endif
...
#ifdef DEBUG_CONTROLLER
   fprintf (outputfile, "*** %f: controller_send_event_up_path - ctlno %d, busno %d, slotno %d, type %d, blkno %lld, bcount %d, flags 0x%x, addr %p\n", simtime, currctlr->ctlno, busno, slotno, curr->type, curr->blkno, curr->bcount, curr->flags, curr);
   fflush( outputfile );
#endif
...
#ifdef DEBUG_CONTROLLER
   fprintf (outputfile, "*** %f: controller_bus_ownership_grant - ctlno %d, busno %d, arbdelay %f, type %d, cause %s, blkno %lld, bcount %d, flags 0x%x, addr %p\n", simtime, currctlr->ctlno, busno, arbdelay, curr->type, getCauseString( curr->cause), curr->blkno, curr->bcount, curr->flags, curr);
   fflush( outputfile );
#endif
...
#ifdef DEBUG_CONTROLLER
   fprintf (outputfile, "*** %f: Inside controller_bus_delay_complete: ctlno = %d, type = %d, cause = %d, devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, ctlno, curr->type, curr->cause, curr->devno, curr->blkno, curr->bcount, curr->flags );
   fflush( outputfile );
#endif
