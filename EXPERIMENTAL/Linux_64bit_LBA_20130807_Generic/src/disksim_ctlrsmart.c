...
static void controller_smart_issue_access (void *issuefuncparam, ioreq_event *curr)
{
   ...
   fprintf (outputfile, "%f: controller_smart_issue_access type %d, devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->type, curr->devno, curr->blkno, curr->bcount, curr->flags );
   fflush( outputfile );
#endif
...
#ifdef DEBUG_CTLRSMART
   fprintf (outputfile, "%f: controller_smart_disk_data_transfer_complete: devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
   fflush( outputfile );
#endif
...
#ifdef DEBUG_CTLRSMART
   fprintf (outputfile, "%f: controller_smart_request_complete  Request completed at smart controller: devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags);
   fflush( outputfile );
#endif
...
#ifdef DEBUG_CTLRSMART
   fprintf (outputfile, "*** %f: controller_smart_host_data_transfer_complete: devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags);
   fflush( outputfile );
#endif
...
#ifdef DEBUG_CTLRSMART
   fprintf (outputfile, "*** %f: controller_smart_host_data_transfer: devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
   fflush( outputfile );
#endif
...
{
#ifdef DEBUG_CTLRSMART
   fprintf (outputfile, "*** %f: controller_smart_request_arrive Request arrived at smart controller: devno %d, blkno %lld, flags %x\n", simtime, curr->devno, curr->blkno, curr->flags);
   fflush( outputfile );
#endif
...
#ifdef DEBUG_CTLRSMART
   fprintf (outputfile, "*** %f: controller_smart_access_complete: devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
   fflush( outputfile );
#endif
...
{
#ifdef DEBUG_CTLRSMART
   fprintf (outputfile, "*** %f: controller_smart_ready_to_transfer: devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
   fflush( outputfile );
#endif
...
{
#ifdef DEBUG_CTLRSMART
   fprintf (outputfile, "*** %f: controller_smart_disconnect: devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
   fflush( outputfile );
#endif
...
{
#ifdef DEBUG_CTLRSMART
   fprintf (outputfile, "*** %f: controller_smart_reconnect_to_transfer: devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
   fflush( outputfile );
#endif
...
{
#ifdef DEBUG_CTLRSMART
   fprintf (outputfile, "*** %f: controller_smart_interrupt_arrive: cause %s, devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, getCauseString( curr->cause ), curr->devno, curr->blkno, curr->bcount, curr->flags );
   fflush( outputfile );
#endif
...
{
#ifdef DEBUG_CTLRSMART
   fprintf (outputfile, "*** %f: controller_smart_interrupt_complete: devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->devno, curr->blkno, curr->bcount, curr->flags );
   fflush( outputfile );
#endif
...
{
#ifdef DEBUG_CTLRSMART
   fprintf (outputfile, "*** %f: controller_smart_event_arrive: type %d, devno %d, blkno %lld, bcount %d, flags 0x%x\n", simtime, curr->type, curr->devno, curr->blkno, curr->bcount, curr->flags );
   fflush( outputfile );
#endif
