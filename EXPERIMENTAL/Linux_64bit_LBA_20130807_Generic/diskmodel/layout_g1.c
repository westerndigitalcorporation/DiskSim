...
static int 
g1_st_lbn(struct dm_disk_if *d, LBA_t lbn) {
...
static dm_ptol_result_t
g1_ptol_0t( struct dm_disk_if *d, struct dm_pbn *p, LBA_t *remapsector)
{
//  dm_angle_t zerol;
//  //  long long max = ((long long)1 << 32);
//
 ...
 */
#if 0  // hurst_r remove for 64 bit LBA
static dm_ptol_result_t
...
static dm_angle_t
g1_lbn_offset(struct dm_disk_if *d, LBA_t lbn1, LBA_t lbn2)
{
...
#if 0  // hurst_r removed for 64 bit LBA
  g1_ptol_nosparing,
