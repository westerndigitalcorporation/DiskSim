...
struct idx_ent {
  ...
  LBA_t lbn;      // absolute if top-level, relative otherwise
  int cyl;      // ditto
  ...
  LBA_t len;        // the number of lbns in one instance of the child
  ...
  LBA_t runlen;     // the number of lbns this entry covers
