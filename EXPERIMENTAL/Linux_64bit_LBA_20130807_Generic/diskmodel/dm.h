...
struct dm_layout_if {
  ...
  //==========================================================================
  // translate LBN to PBN   0t transformation
  // if the lbn was remapped, *remapsector will be set to a nonzero
  // value if remapsector is non-NULL.  This emulates the behavior
  // of disksim's global of the same name.
  //==========================================================================
  ...
  //==========================================================================
  // translate PBN to LBN  0t translation
  // if the pbn is defective and remapped,
  // *remapsector will be set to a nonzero value if remapsector is non-NULL
  //==========================================================================

  dm_ptol_result_t
  (*dm_translate_ptol_0t)(
          struct dm_disk_if *,
          struct dm_pbn *p,
          LBA_t *remapsector);
  ...
  dm_ptol_result_t
  (*dm_defect_count)(struct dm_disk_if *d, struct dm_pbn *track, int *result);
};
...
struct dm_mech_if {
  ...
  // the 2nd argument.  This is a convenience wrapper for rottime.
  dm_time_t(*dm_xfertime)(
          struct dm_disk_if *d,
          struct dm_mech_state *,
          int len);
