...
/* Provided by process-flow simulator */

void    pf_setcallbacks (void);
void    pf_initialize (int seedvalue);
void    pf_resetstats (void);
void    pf_cleanstats (void);
void    pf_printstats (void);
void    pf_readparams (FILE *parfile);
void	pf_param_override (int structtype, char *paramname, char *paramval, int first, int last);
